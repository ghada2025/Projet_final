      ...
      <div className="flex items-center justify-center relative" id="Home">
        <div className="max-w-[1400px] px-5 md:px-[50px] w-full">
            ...
            <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10">
              <div className="flex flex-col items-center text-center md:items-start md:text-start">
                ...
                <p className="header-width header-p-font header-p-padding">
                  ...
                  innovative and immersive approach to learning.
                </p>
                <a href="#Contact">
          ...
          <section className="h-auto section-padding relative" id="Contact">
            <div className="text-center header-p-padding flex flex-col items-center">
              <div>
                <h1 className="header-font pt-4 text-xl sm:text-3xl md:text-4xl">
                  Contact us
                </h1>
              ...
              <div className="relative mt-8">
                ...
                <Image
                  ...
                  width={150}
                  height={150}
                  className="absolute top-[90px] left-[-108px] z-0 md:top-[120px] md:left-[-103px] sm:top-[100px] sm:left-[-115px] [@media(max-width:480px)]:hidden had"
                />
              </div>
            </div>
          </section>

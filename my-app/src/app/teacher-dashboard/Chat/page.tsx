                ...
                <ResizablePanelGroup direction="horizontal" className="max-w-[1200px] p-10">
                    ...
                    <ResizablePanel defaultSize={75} className="rounded-r-xl border-y border-r bg-white">
                        <div className="h-full flex flex-col">
                            ...
                            <div className="flex gap-2 p-5 border-t items-center [@media(max-width:420px)]:flex-col [@media(max-width:420px)]:items-center">
                        <input
                            type="text"
                            placeholder="Write a message..."
                            value={newMessage}
                            onChange={(e) => setNewMessage(e.target.value)}
                            className="flex-1 px-4 py-2 min-w-0 rounded-sm border cursor-pointer focus:outline-none focus:ring-2 shadow-sm text-sm"
                        />
                        <div className="flex gap-2 overflow-x-auto scroll-container">
                            <Component></Component>
                            <Button
                            size="icon"
                            className="hover:cursor-pointer border cursor-pointer"
                            variant="outline"

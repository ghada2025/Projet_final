      ...
      {isPositive && (
        ...
        {!isPositive && (
          <RiArrowRightDownLine
            className="absolute right-0 top-0 opacity-0 group-has-[a:hover]:opacity-100 transition-opacity text-red-500"
            size={20}
            aria-hidden="true"
          />
        )}
        ...
        <div>
          <a
            href="#"
            className="font-semibold tracking-widest text-xs uppercase text-muted-foreground/60 before:absolute before:inset-0"
          >
            {title}
          </a>

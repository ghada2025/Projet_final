    ...
    return(
        ...
        <div className="flex justify-between items-start text-start width-card nav-gap border-5 border-black p-5">
            ...
            <div>
                ...
                <button className="text-blue-500 flex items-center h-9 gap-2 cursor-pointer header-p-font card mt-2">Learn more<ArrowRight className="text-blue-500 mt-1"></ArrowRight></button>
            </div>
        </div>
        </>
    )
